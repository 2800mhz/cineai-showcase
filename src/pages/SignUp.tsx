      ...
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          <Link to="/" className="inline-flex items-center gap-2 text-primary hover:opacity-80 transition-opacity mb-6">
            ...
            <span className="text-2xl font-bold">AI CineDB</span>
          </Link>
          <h1 className="text-3xl font-bold mt-6">Create your account</h1>
          <p className="text-muted-foreground mt-2">Join the AI film community</p>
        </div>

        <form onSubmit={handleSignUp} className="space-y-6 glass rounded-2xl p-8">
